...
def sampler(orchestrator_path, seed):
    ...
    environment_samples = {
        ...
        "rain_intensity": random.uniform(ranges["rain_intensity_min"], ranges["rain_intensity_max"]),
        "snow_intensity": random.uniform(ranges["snow_intensity_min"], ranges["snow_intensity_max"]),
